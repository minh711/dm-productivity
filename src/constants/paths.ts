export const HOME_PATH = '/',
  ...
  DAILY_LOG_PATH = '/daily-log',
  LOG_LIST_PATH = '/daily-log/log-list',
  LOG_TYPE_AND_CATEGORY_PATH = '/daily-log/log-type-category',
...
export const routeTitles: Record<string, string> = {
  [HOME_PATH]: 'home',
  [SETTINGS_PATH]: 'settings',
  [DAILY_LOG_PATH]: 'daily-log.title',
  [LOG_LIST_PATH]: 'daily-log.log-list.title',
